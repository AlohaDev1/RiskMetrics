...
namespace MetricsCorporation
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/kendo/css").Include("~/Content/kendo.common.min.css",
