...
namespace Orchard.jQuery {
    public class ResourceManifest : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineScript("jQuery").SetUrl("jquery-1.9.min.js", "jquery-1.9.js").SetVersion("1.9")
                .SetCdn("//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.9.min.js", "//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.9.min.js", true);
