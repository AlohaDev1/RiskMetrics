...
namespace MetricsCorporation.Orchard.Web
{
    ...
    public class MetricsCorporationAuthorizationService : IAuthorizationService
    {
        ...
        public MetricsCorporationAuthorizationService(IRoleService roleService, IWorkContextAccessor workContextAccessor, IAuthorizationServiceEventHandler authorizationServiceEventHandler)
        {
